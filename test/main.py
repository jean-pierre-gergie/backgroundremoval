...
from metrics_dl import dice_loss, dice_coef, iou
...
if __name__ == "__main__":
    ...
    with CustomObjectScope({'iou': iou, 'dice_coef': dice_coef, 'dice_loss': dice_loss}):
        model = tf.keras.models.load_model("dlv3p.h5")
    # model.summary()

    """ Video Path """
    video_path = "C:\\Users\\jpg\\Desktop\\chrissakr\\test\\test_videos\\myvideo.mp4"
    ...
    out = cv2.VideoWriter(f'C:\\Users\\jpg\\Desktop\\chrissakr\\test\\output_vids\\myvideo.avi', fourcc, 30, (w, h), True)
